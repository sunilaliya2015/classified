    ...
    <div class="col-md-10 col-sm-12 box-center center mt-4 mb-0">
        <div class="row">
            ...
            <div class="col-xl-12 text-center">
                <img class="img-fluid" src="<?php echo e(url('images/paypal/payment.png')); ?>" title="<?php echo e(trans('paypal::messages.Payment with Paypal')); ?>">
            </div>
...
<?php /**PATH G:\xampp\htdocs\classified\extras\plugins\paypal\resources\views/paypal.blade.php ENDPATH**/ ?>