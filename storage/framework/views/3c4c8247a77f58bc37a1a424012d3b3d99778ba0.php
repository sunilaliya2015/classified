                                    ...
                                    <fieldset>
                                        ...
                                        <div class="input-group row mt-4">
                                            <div class="col-md-12 text-center">
                                                ...
                                                <a id="nextStepAction" href="<?php echo e($nextStepUrl); ?>" class="btn btn-default btn-lg"><?php echo e(t('Next')); ?></a>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        ?>
            pictureFieldEl.fileinput(
            {
                ...
                <?php if(isset($post->pictures) && ($post->pictures instanceof \Illuminate\Support\Collection)): ?>
					/* Retrieve current images */
					/* Setup initial preview with data keys */
					initialPreview: [
					<?php for($i = 0; $i <= $picturesLimit-1; $i++): ?>
						<?php if(!$post->pictures->has($i) || !isset($post->pictures->get($i)->filename_url_medium)) continue; ?>
						'<?php echo e(str_replace('humb-', 'thumb-', $post->pictures->get($i)->filename_url_medium)); ?>',
					<?php endfor; ?>
					],
					/* Initial preview configuration */
					initialPreviewConfig: [
					<?php for($i = 0; $i <= $picturesLimit-1; $i++): ?>
						<?php if(!$post->pictures->has($i) || !isset($post->pictures->get($i)->filename)) continue; ?>
						<?php
						/* Get the file path */
		...
		function reorderPictures(params)
		{
			...
			let postId = '<?php echo e(request()->segment(2)); ?>';
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\classified\resources\views/post/createOrEdit/multiSteps/photos/edit.blade.php ENDPATH**/ ?>