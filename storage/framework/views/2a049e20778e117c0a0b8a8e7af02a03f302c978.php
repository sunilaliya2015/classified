		...
		<div class="container">
			...
			<div class="navbar-identity p-sm-0">
				...
				<a href="<?php echo e(url('/')); ?>" class="navbar-brand logo logo-title">
					<img src="<?php echo e(config('settings.app.logo_url')); ?>" class="main-logo" style="height: 40px;"/>
				</a>
			...
			<div class="navbar-collapse collapse" id="navbarsDefault">
				...
				<ul class="nav navbar-nav ms-auto navbar-right">
					...
					<li class="nav-item postadd">
						<?php if(config('settings.single.guests_can_post_listings') != '1'): ?>
...
</div><?php /**PATH G:\xampp\htdocs\classified\resources\views/errors/layouts/inc/header.blade.php ENDPATH**/ ?>